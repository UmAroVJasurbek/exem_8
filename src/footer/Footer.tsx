    ...
    <div className="footer_box">
      <div className="footer">
        ...
        <div className="footer_component">
          ...
          <ul>
            <li className="footer_icon_li">
              <IoLogoFacebook className="footer_icon" /> facebook
            </li>
            <li className="footer_icon_li">
              <FaSquareTwitter className="footer_icon" /> Twitter
            </li>
          </ul>
        </div>
        <div className="footer_component">
      ...
      <div className="footer__copyright">
        <p>
          ...
          <span className="footer__copyright_span">
            Accessibility, User Agreement, Payment terms of use, Privacy,
            Cookies
          </span>
        </p>
      </div>
